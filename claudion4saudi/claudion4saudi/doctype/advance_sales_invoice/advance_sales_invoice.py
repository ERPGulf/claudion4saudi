...
# 		validate_docs_for_voucher_types(["Advance Sales Invoice"])
...
# 		if self.party_type == "Customer":
# 			return ("Sales Order", "Sales Invoice", "Journal Entry", "Dunning", "Advance Sales Invoice")
# 		elif self.party_type == "Supplier":
# 			return ("Purchase Order", "Purchase Invoice", "Journal Entry", "Advance Sales Invoice")
...
# 			frappe.msgprint(
# 				_(
# 					"References {0} of type {1} had no outstanding amount left before submitting the Advance Sales Invoice. Now they have a negative outstanding amount."
# 				).format(
# 					frappe.bold(comma_and([d.reference_name for d in references])),
# 					_(reference_doctype),
# 				)
# 				+ "<br><br>"
# 				+ _("If this is undesirable please cancel the corresponding Advance Sales Invoice."),
# 				title=_("Warning"),
# 				indicator="orange",
# 			)
...
# 	):
# 		"""
# 		Advance Sales Invoice could be in base currency while reference's payment schedule
...
# 				gle.update(
# 					{
# 						"against_voucher_type": "Advance Sales Invoice",
...
# 		if reference.reference_doctype == "Advance Sales Invoice":
...
# 			"account_currency": self.party_account_currency,
# 			"cost_center": self.cost_center,
# 			"voucher_type": "Advance Sales Invoice",
...
# 	frappe.msgprint("weeeeeeeeeeeeee")
...
# 	"""
# 	Updates accounting dimensions in Advance Sales Invoice based on the accounting dimensions in the reference document
# 	"""
